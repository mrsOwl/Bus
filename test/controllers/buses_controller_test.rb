...
class BusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus" do
    assert_difference('Bus.count') do
      post buses_url, params: { bus: { bus_station: @bus.bus_station, bus_time_start: @bus.bus_time_start, bus_time_stop: @bus.bus_time_stop, number: @bus.number } }
    end
  ...
  test "should update bus" do
    patch bus_url(@bus), params: { bus: { bus_station: @bus.bus_station, bus_time_start: @bus.bus_time_start, bus_time_stop: @bus.bus_time_stop, number: @bus.number } }
